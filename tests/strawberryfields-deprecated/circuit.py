...
class Circuit:
    ...
    def __init__(self, num_modes, cutoff_dim, hbar=2., pure=True, batch_size=None):
        ...
        self.reset(pure, num_subsystems=num_modes, cutoff_dim=cutoff_dim, hbar=hbar)
    ...
    def _maybe_batch(self, param, convert_to_tensor=True):
        ...
        Parameter can be either a scalar or a vector of length of batch_size."""
        shape_err = False
    ...
    # done
    def reset(self, pure=True, num_subsystems=None, cutoff_dim=None, hbar=None):
        r"""
